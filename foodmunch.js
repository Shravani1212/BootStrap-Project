$(document).ready(function() {
  ...
  $("li").click(function(){
    ...
    if(address!==null){
      ...
      Go and redeem your gift with  
      ${Math.ceil(Math.random())}#abc code
    ...
    hope you will enjoy the meal!!!
     happy Meal;;;`)
      ...
      alert(`Sorry You haven't ordered anything`)
    }
  })
...
function placeOrder() {
  ...
  var message = "Order Placed!\n\nName: " + name + "\nEmail: " + email + "\nSelected Food Items: " + selectedFoodItems.join(", ") + "\nPayment Method: " + paymentMethod + "\nDelivery Address: " + address +`Thank You For Ordering Enjoy the taste!!! have a Nice day!!! Go and redeem your gift ${Math.ceil(Math.random())}#abc  code`;
  alert(message);
